...
%			 \textbf{Propositional Logic syntax concept} & \textbf{Expressions} \\ \hline \hline 
%			 Sentence & \textit{AtomicSentence} | \textit{ComplexSentence}\\ \hline 
%			 Atomic sentence & \textit{True} | \textit{False} | \textit{$P_t$} | \textit{$Q_t$} | \textit{$R_t$} | ...\\ \hline 
%			 Complex Sentence & 
%			 
%%			 \vspace{-0.5cm}
%%			 \begin{itemize}
...
%		    \tabitem $\lambda_1 < \lambda_2 < 0$ & Improper node/node & Asym.~stable \\
%			 
%			 \\  \hline 
%			 
%			 
